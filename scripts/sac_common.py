...
# PKC-compatible catalogs first, then SAC architecture catalogs.
PKC_CATALOGS = (
    "meetings",
    "experiments",
    "discoveries",
...
# Unique ordered catalogs for bundle init
CATALOGS = tuple(dict.fromkeys(list(PKC_CATALOGS) + list(SAC_CATALOGS)))
