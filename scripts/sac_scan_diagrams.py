...
KIND_HINTS = [
    ...
    (re.compile(r"C4Context|System_Boundary|c4-l1|Level 1", re.I), "C4ContextDiagram"),
    (re.compile(r"C4Container|Container_Boundary|c4-l2|Level 2", re.I), "C4ContainerDiagram"),
    (re.compile(r"C4Component|c4-l3|Level 3", re.I), "C4ComponentDiagram"),
    (re.compile(r"C4Code|c4-l4|Level 4", re.I), "C4CodeDiagram"),
